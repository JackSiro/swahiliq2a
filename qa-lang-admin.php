...
*/
	...
	return array(
		'active_widgets_explanation' => 'Widgeti zilizo hai kwa sasa:',
		'add_category_button' => 'Ongeza kikundi',
		'add_field_button' => 'Ongeza uga',
		...
		'add_widget_button' => 'Ongeza widgeti',
		'add_widget_link' => ' - ^1ongeza widgeti^2',
		'admin_title' => 'Kitovu cha umiliki',
		'after_footer' => 'Baada ya viungo mwisho',
		'after_main_menu' => 'After tabs at top',
		'after_x' => 'Kabla "^"',
		'after_x_tab' => 'Kabla "^" tab',
		...
		'categories_introduction' => 'To get started with categories, click the \'Add Kikundi\' button.',
		'categories_not_shown' => 'Some questions have categories which will not be displayed.',
		'categories_title' => 'Categories',
		'category_add_sub' => 'add sub-kikundi',
		'category_added' => 'Kikundi added',
		'category_already_used' => 'This is already being used by a kikundi',
		'category_default_slug' => 'kikundi-^',
		'category_description' => 'Optional kikundi description:',
		'category_max_depth_x' => 'Some options may be hidden to prevent a kikundi going deeper than ^ levels.',
		'category_move_parent' => 'move to different parent',
		'category_name' => 'Kikundi name:',
		'category_name_first' => 'Name of first kikundi:',
		'category_no_add_subs_x' => 'This kikundi cannot have sub-categories because it is already ^ levels down.',
		'category_no_delete_subs' => 'This kikundi cannot be deleted because it has a sub-kikundi.',
		'category_no_sub_error' => '^q question/s in this kikundi have no sub-kikundi - ^1set sub-kikundi^2',
		'category_no_sub_to' => 'Move questions in ^ with no sub-kikundi to:',
		'category_no_subs' => 'None',
		'category_none_error' => '^q question/s currently have no kikundi - ^1set kikundi^2',
		'category_none_to' => 'Move questions with no kikundi to:',
		'category_parent' => 'Parent kikundi:',
		'category_saved' => 'Kikundi saved',
		'category_slug' => 'Kikundi slug - URL fragment:',
		...
		'delete_category' => 'Delete this kikundi',
		'delete_category_reassign' => 'Delete this kikundi and reassign its questions to:',
		...
		'recalc_categories_note' => ' - for post categories and kikundi counts',
